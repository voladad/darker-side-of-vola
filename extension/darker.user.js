...
(function () {
    ...
    const css = [
        ...
        ".icon-home, .icon-list, .file_clock, .icon-anonymous, .dropdown_icon { ",
        "    display: none !important; ",
        "} ",
        ...
        "} "
        "#room_content_fixed > div.ui_frame_container > div > div.ui_frame_body.ui_frame_body_bar > div > table > tr:nth-child(1) > td:nth-child(2) > textarea {"
"resize: auto;"
"}"
